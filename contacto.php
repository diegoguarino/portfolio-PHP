...
<body id="contacto" class="d-flex flex-column h-100">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <textarea name="txtMensaje" id="txtMensaje" class="form-control shadow"
                            placeholder="Escribe aquí tu mensaje" rows="5" required></textarea>
                    </div>
                    <div class="">
    ...
    <footer class="container mt-auto pb-sm-4">
        <div class="btn-whatsapp">
            <a href="https://api.whatsapp.com/send?phone=59891320262" target="_blank" title="Whatsapp"><i
