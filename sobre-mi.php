...
<body>
        ...
        <div class="container">
            <div class="row pb-5">
                <div class="col-12 col-sm-5 px2 mt-sm-5">
                    <h1>Sobre mí</h1>
                    <p class="pt-sm-4 pb-sm-5">Apasionado por la tecnología y gestión de proyectos. Soy alumno de cursos de
                        programación Full
                        Stack
                ...
                <div class="col-12 col-sm-3 offset-sm-2 mt-5">
                    <img src="imagenes/diego_perfil.jpg" class="foto-perfil img-fluid mx-auto">
                </div>
            </div>
        </div>
    ...
    <div>
        <a href="https://api.whatsapp.com/send?phone=59891320262" target="_blank" title="Whatsapp" class="btn-whatsapp"><i
